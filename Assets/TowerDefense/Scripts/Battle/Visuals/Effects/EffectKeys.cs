namespace TowerDefensePrototype.Battle.Visuals.Effects
{
    public static class EffectKeys
    {
        public const string HpDamageText = "damage_hp_text_effect";
        ...
        public const string BossIncoming = "boss_incoming";
    }
}